...
Unobfiscuated cause its just a shitty smaller sized mod of Rayfield and cause hexavate wouldve died trying to obf this

Made By MrolivesGaming
...
function getgenv(a)
	...
	function isfile(a,z,v)
		return false
	end
	
	function writefile(a,s,m)
		return false
	end
	
	function isfolder(v,h,z)
		return false
	end

	function writefolder(r,q,k)
return false
	end
	

	function makefolder(m,f,n)
		return false
	end
...
local Release = "V7.1.6"
local NotificationDuration = 6.5
local RayfieldFolder = "HexHubV7"
local ConfigurationFolder = RayfieldFolder.."/GameConfigurations"
local ConfigurationExtension = ".Hex"
local GlobalConfig = RayfieldFolder.."/LibraryConfig"..ConfigurationExtension
...
local RayfieldLibrary = {
	...
	Theme = {
		...
		Zunar = {
			...
			Background = Color3.fromRGB(105, 163, 255),
			Topbar = Color3.fromRGB(66, 130, 255),
			Shadow = Color3.fromRGB(252, 255, 255),

			NotificationBackground = Color3.fromRGB(20, 20, 20),
			NotificationActionsBackground = Color3.fromRGB(230, 230, 230),

			TabBackground = Color3.fromRGB(133, 176, 255),
			TabStroke = Color3.fromRGB(141, 189, 255),
			TabBackgroundSelected = Color3.fromRGB(255, 255, 255),
			TabTextColor = Color3.fromRGB(252, 255, 255),
			SelectedTabTextColor = Color3.fromRGB(0, 0, 0),

			ElementBackground = Color3.fromRGB(90, 135, 255),
			ElementBackgroundHover = Color3.fromRGB(112, 154, 255),
			SecondaryElementBackground = Color3.fromRGB(79, 121, 232), -- For labels and paragraphs
			ElementStroke = Color3.fromRGB(252, 255, 255),
			SecondaryElementStroke = Color3.fromRGB(240, 242, 242), -- For labels and paragraphs

			SliderBackground = Color3.fromRGB(105, 163, 255),
			SliderProgress = Color3.fromRGB(133, 176, 255),
			SliderStroke = Color3.fromRGB(255,255,255),

			ToggleBackground = Color3.fromRGB(105, 163, 255),
			ToggleEnabled = Color3.fromRGB(132, 167, 255),
			ToggleDisabled = Color3.fromRGB(66, 130, 255),
			ToggleEnabledStroke = Color3.fromRGB(252, 255, 255),
			ToggleDisabledStroke = Color3.fromRGB(136, 188, 255),
			ToggleEnabledOuterStroke = Color3.fromRGB(252, 255, 255),
			ToggleDisabledOuterStroke = Color3.fromRGB(136, 188, 255),

			InputBackground = Color3.fromRGB(66, 130, 255),
			InputStroke = Color3.fromRGB(252, 255, 255),
			PlaceholderColor = Color3.fromRGB(213, 216, 216)
		},
		Light = {
...
local TabList = Main.SideBar.TabList
...
function ChangeTheme(ThemeName)
	...
	for _, obj in ipairs(TabList:GetDescendants()) do
		if obj:IsA("Frame") and obj.Name ~= "PlaceHolder" then
			if obj.BackgroundColor == SelectedTheme.TabBackgroundSelected then
			obj.UIStroke.Color = SelectedTheme.TabStroke
			obj.BackgroundColor3 = SelectedTheme.TabBackgroundSelected
			obj.Image.ImageColor3 = SelectedTheme.SelectedTabTextColor
				obj.Settings.Title.TextColor3 = SelectedTheme.SelectedTabTextColor
			elseif obj.BackgroundColor == SelectedTheme.TabBackground then
				obj.UIStroke.Color = SelectedTheme.TabStroke
				obj.BackgroundColor3 = SelectedTheme.TabBackground
				obj.Image.ImageColor3 = SelectedTheme.TabTextColor
				obj.Settings.Title.TextColor3 = SelectedTheme.TabTextColor
end
		end
	end
	...
	Rayfield.Main.Topbar.Mini.ImageColor3 = SelectedTheme.TextColor
	
	
	Rayfield.Main.SideBar.BackgroundColor3 = SelectedTheme.Topbar
	Rayfield.Main.SideBar.CornerRepair.BackgroundColor3 = SelectedTheme.Topbar


	Topbar.USERHOLDER.UIStroke.Color = SelectedTheme.TabStroke
	Topbar.USERHOLDER.BackgroundColor3 = SelectedTheme.TabBackground
	Topbar.USERHOLDER.Thumbnail.ImageColor3 = SelectedTheme.TabTextColor
	Topbar.USERHOLDER.UserName.TextColor3 = SelectedTheme.TabTextColor
	
	SideBar.Settings.UIStroke.Color = SelectedTheme.TabStroke
	SideBar.Settings.BackgroundColor3 = SelectedTheme.TabBackground
	SideBar.Settings.Image.ImageColor3 = SelectedTheme.TabTextColor
	SideBar.Settings.Title.TextColor3 = SelectedTheme.TabTextColor
...
function RayfieldLibrary:Notify(NotificationSettings)
		...
		if NotificationSettings.Actions then
			for _, Action in pairs(NotificationSettings.Actions) do
				...
				NewAction.MouseButton1Click:Connect(function()
					...
					if not Success then
						print("CARMLWARE | Action: "..Action.Name.." Callback Error " ..tostring(Response))
					end
	...
	if getgenv().SecureMode == nil then
		...
		--[[if Rayfield.Name == "CARMLWARE" then
...
function Hide()
	Debounce = true
	RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping The ui toggle Keybind", Duration = 7})
	...
	TweenService:Create(Main.SideBar, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
	TweenService:Create(Main.SideBar.Divider, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
	TweenService:Create(Main.SideBar.CornerRepair, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()


	TweenService:Create(SideBar.UIStroke, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
	...
	TweenService:Create(Topbar.USERHOLDER, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
	TweenService:Create(Topbar.USERHOLDER.UserName, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {TextTransparency = 1}):Play()
	TweenService:Create(Topbar.USERHOLDER.Thumbnail, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 1}):Play()
	--TweenService:Create(Topbar.User.Shadow, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 1}):Play()
	TweenService:Create(Topbar.USERHOLDER.UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
	
	TweenService:Create(SideBar.Settings, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
	TweenService:Create(SideBar.Settings.Title, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {TextTransparency = 1}):Play()
	TweenService:Create(SideBar.Settings.Image, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 1}):Play()
	TweenService:Create(SideBar.Settings.Shadow, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 1}):Play()
	TweenService:Create(SideBar.Settings.UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
...
function Close()
	...
	RayfieldLibrary:Notify({Title = "HexHub Closed", Content = "HexHub Has Been CLosed, Re-Execute The Script To Reopen", Duration = 7})
...
function Unhide()
	...
	TweenService:Create(Main.SideBar, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
	TweenService:Create(Main.SideBar.Divider, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
	TweenService:Create(Main.SideBar.CornerRepair, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()

	TweenService:Create(SideBar.Settings, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundTransparency = 0.7}):Play()
	TweenService:Create(SideBar.Settings.Image, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 0.2}):Play()
	TweenService:Create(SideBar.Settings.Shadow, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 0.7}):Play()
	TweenService:Create(SideBar.Settings.Title, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {TextTransparency = 0.2}):Play()
	TweenService:Create(SideBar.Settings.UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
	
	TweenService:Create(Topbar.USERHOLDER, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundTransparency = 0.7}):Play()
	TweenService:Create(Topbar.USERHOLDER.Thumbnail, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 0.2}):Play()
	--TweenService:Create(Topbar.User.Shadow, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 0.7}):Play()
	TweenService:Create(Topbar.USERHOLDER.UserName, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {TextTransparency = 0.2}):Play()
	TweenService:Create(Topbar.USERHOLDER.UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	Topbar.USERHOLDER.Visible = false
	SideBar.Visible = false
	SideBar.Settings.Visible = false
	Elements.Visible = false
	
	Topbar.USERHOLDER.UserName.Text = "@"..game.Players.LocalPlayer.Name
	Topbar.USERHOLDER.Thumbnail.Image = game.Players:GetUserThumbnailAsync(game.Players.LocalPlayer.UserId,Enum.ThumbnailType.HeadShot,Enum.ThumbnailSize.Size100x100)

	pcall(function()
		if not Settings.ConfigurationSaving.FileName then
			Settings.ConfigurationSaving.FileName = tostring(game.PlaceId)
		end
		if not isfolder(RayfieldFolder.."/"..ConfigurationFolder) then
	...
	function Window:CreateTab(Name,Image,HasButton)
		local SDone = false
		...
		if Image then
			...
			TabButton.Title.Size = UDim2.new(0.559, 0,0, 14)
			TabButton.Title.Position = UDim2.new(0.621, 0,0.5, 0)
		...
		TabButton.Visible = HasButton or true
		...
		TabButton.Interact.MouseButton1Click:Connect(function()
			...
			TweenService:Create(SideBar.Settings, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.TabBackground}):Play()
			TweenService:Create(SideBar.Settings.Title, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {TextColor3 = SelectedTheme.TabTextColor}):Play()
			TweenService:Create(SideBar.Settings.Image, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {ImageColor3 = SelectedTheme.TabTextColor}):Play()
			TweenService:Create(SideBar.Settings, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = 0.7}):Play()
			TweenService:Create(SideBar.Settings.Title, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {TextTransparency = 0.2}):Play()
			TweenService:Create(SideBar.Settings.Image, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {ImageTransparency = 0.2}):Play()
			TweenService:Create(SideBar.Settings.Shadow, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 0.7}):Play()
			TweenService:Create(SideBar.Settings.UIStroke, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
		...
		function Tab:CreateStatus(Data)
			local StatusValue = {}

			local Label = Elements.Template.Status:Clone()
			Label.Title.Text = Data["Title"]
			Label.Status.Text = Data["Status"]
			Label.Status.TextColor3 = Data["StatusColor"] or Color3.fromRGB(255, 255, 255)
			Label.Visible = true
			Label.Parent = TabPage
			...
			function StatusValue:Set(UpdData)
				Label.Title.Text = UpdData["Title"]
				Label.Status.Text = UpdData["Status"]
				Label.Status.TextColor3 = UpdData["StatusColor"] or Color3.fromRGB(255, 255, 255)
			end
		...
		function Tab:CreateParagraph(ParagraphSettings)
			...
			function ParagraphValue:Set(NewParagraphSettings)
				...
				Paragraph.Content.TextColor3 = NewParagraphSettings.ContentColor or Color3.fromRGB()
			end
		...
		function Tab:CreateSlider(SliderSettings)
			...
			function SliderSettings:Set(NewVal)
				...
				if not Success then
					...
					TweenService:Create(Slider.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
					Slider.Title.Text = "Callback Error"
					print("HexHub | "..SliderSettings.Name.." Callback Error " ..tostring(Response))
					wait(0.5)
					Slider.Title.Text = SliderSettings.Name
					TweenService:Create(Slider, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
					TweenService:Create(Slider.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
	...
	task.spawn(function() -- settingtab
	
		local SettingsTab = Window:CreateTab("Settings",nil,false)
		
		warn("SETTINGSTABADDING")
	...
	SettingsTab:CreateKeybind({
		...
		Flag = "UiToggleKeybind", -- A flag is the identifier for the configuration file, make sure every element has a different flag if you're using configuration saving to ensure no overlaps
		Callback = function(Keybind)
			GlobalSettings.UIKeybind = Keybind
			if Keybind == GlobalSettings.UIKeybind then
	...
	SettingsTab:CreateDropdown({
		Name = "UI Theme",
		Options = {"Default","Light","Zunar"},
		CurrentOption = GlobalSettings.SelectedTheme,
		...
		Callback = function(Option)
			GlobalSettings.SelectedTheme = Option
			ChangeTheme(Option)
		end,
	})
	...
	SettingsTab:CreateButton({
		...
		SideBar.Settings.Interact.MouseButton1Down:Connect(function()
			warn("GOING TO SETTING START")
			warn(Minimised)
			if Minimised then return end
			
			task.spawn(function(...)
				warn("MOVETO")
				Elements.UIPageLayout:JumpTo(Elements:WaitForChild("Settings"))
				warn(Elements.UIPageLayout)
				warn(Elements:WaitForChild("Settings"))
			end)
			
		TweenService:Create(SideBar.Settings, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
		TweenService:Create(SideBar.Settings.UIStroke, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
		TweenService:Create(SideBar.Settings.Title, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {TextTransparency = 0}):Play()
		TweenService:Create(SideBar.Settings.Image, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {ImageTransparency = 0}):Play()
		TweenService:Create(SideBar.Settings, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.TabBackgroundSelected}):Play()
		TweenService:Create(SideBar.Settings.Title, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {TextColor3 = SelectedTheme.SelectedTabTextColor}):Play()
		TweenService:Create(SideBar.Settings.Image, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {ImageColor3 = SelectedTheme.SelectedTabTextColor}):Play()
		TweenService:Create(SideBar.Settings.Shadow, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 0.9}):Play()

		for _, OtherTabButton in ipairs(TabList:GetChildren()) do
			if OtherTabButton.Name ~= "Template" and OtherTabButton.ClassName == "Frame" and OtherTabButton ~= SideBar.Settings and OtherTabButton.Name ~= "Placeholder" then
				TweenService:Create(OtherTabButton, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.TabBackground}):Play()
				TweenService:Create(OtherTabButton.Title, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {TextColor3 = SelectedTheme.TabTextColor}):Play()
				TweenService:Create(OtherTabButton.Image, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {ImageColor3 = SelectedTheme.TabTextColor}):Play()
				TweenService:Create(OtherTabButton, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = 0.7}):Play()
		...
		if Elements:FindFirstChild(FirstTabName) then
		
			Elements.UIPageLayout:JumpTo(Elements:FindFirstChild(FirstTabName))
...
--	TweenService:Create(Main, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 500, 0, 475)}):Play()
	...
	Topbar.Mini.ImageTransparency = 1

	
	SideBar.BackgroundTransparency = 1
	--SideBar.Divider.Size = UDim2.new(0, 0, 0, 1)
	...
	Topbar.Visible = true
	Topbar.USERHOLDER.Visible = true
	...
	TweenService:Create(SideBar, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
	TweenService:Create(SideBar.CornerRepair, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
	wait(0.1)
	--TweenService:Create(Topbar.Divider, TweenInfo.new(1, Enum.EasingStyle.Quint), {Size = UDim2.new(1, 0, 0, 1)}):Play()
	--TweenService:Create(SideBar.Divider, TweenInfo.new(1, Enum.EasingStyle.Quint), {Size = UDim2.new(1, 0, 0, 1)}):Play()
	wait(0.1)
	TweenService:Create(Topbar.Title, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {TextTransparency = 0}):Play()
	wait(0.1)
	TweenService:Create(Topbar.Mini, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {ImageTransparency = 0.8}):Play()
	wait(0.3)
	SideBar.Settings.Visible = true
	...
	function Window:BindClose(Func)

		Topbar.Hide.MouseButton1Down:Connect(function()
			Func()
...
Topbar.Mini.MouseButton1Click:Connect(function()
	if Debounce then return end
	if Hidden then
		Hidden = false
		Minimised = false
	...
	if CEnabled then
		pcall(function()
			if isfile(ConfigurationFolder .. "/" .. CFileName .. ConfigurationExtension) then
				...
				RayfieldLibrary:Notify({Title = "Loaded Script Config", Content = "Loaded Configuration from past session"})
			end
		end)
	end
end
